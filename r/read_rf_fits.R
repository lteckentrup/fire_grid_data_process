...
plot(NS_TOP_height_cm~pred.value,data = predic.ns.h,ylim=c(0,200))
abline(a=0,b=1)
# plot(NS_TOP_height_cm~tmax,data = predic.ns.h,ylim=c(0,200))
summary(lm(NS_TOP_height_cm~pred.value,data = predic.ns.h))

rmse.func(predic.ns.h$pred.value,predic.ns.h$NS_TOP_height_cm)
